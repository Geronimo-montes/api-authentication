...
export class Error100 {
  /**
   * Se utiliza para indicar que la primera parte de la petición del navegador se ha recibido correctamente
   */
  static get Continue() {
    return 100;
  }
   ...
   */
  static get ProcessingWebDAV___RFC_2518() {
    return 102;
  }
...
export class Error200 {
  ...
  /**
   * La petición ha sido aceptada para procesamiento, pero este no ha sido completado. La petición eventualmente puede no haber sido satisfecha, ya que podría ser no permitida o prohibida cuando el procesamiento tenga lugar
   */
  static get Accepted() {
    return 202;
  }
   ...
   */
  static get Non_Authoritative_Information_desde_HTTP_1_1() {
    return 203;
  }
   ...
   */
  static get Multi_Status_Multi_Status_WebDAV() {
    return 207;
  }
   ...
   */
  static get Already_Reported_WebDAV() {
    return 208;
  }
...
export class Error300 {
   ...
   */
  static get Found_antes_Moved_Temporarily() {
    return 302;
  }
   ...
   */
  static get See_Other_desde_HTTP_1_1() {
    return 303;
  }
   ...
   */
  static get Use_Proxy_desde_HTTP_1_1() {
    return 305;
  }
   ...
   */
  static get Temporary_Redirect_desde_HTTP_1_1() {
    return 307;
  }
...
export class Error400 {
   ...
   */
  static get Unprocessable_Entity_WebDAV___RFC_4918() {
    return 422;
  }
   ...
   */
  static get Locked_WebDAV___RFC_4918() {
    return 423;
  }
   ...
   */
  static get Failed_Dependency_WebDAV_RFC_4918() {
    return 424;
  }
   ...
   */
  static get Upgrade_Required_RFC_7231() {
    return 426;
  }
...
export class Error500 {
   ...
   */
  static get Variant_Also_Negotiates_RFC_2295() {
    return 506;
  }
   ...
   */
  static get Insufficient_Storage_WebDAV___RFC_4918() {
    return 507;
  }
   ...
   */
  static get Loop_Detected_WebDAV() {
    return 508;
  }
   ...
   */
  static get Not_Extended_RFC_2774() {
    return 510;
  }
